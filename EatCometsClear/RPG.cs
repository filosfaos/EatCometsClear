...
namespace EatCometsClear
{
    class RPG : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            uint buttontextsize = (uint)(pomX * 0.030);
            ...
            */
            ...
            hudelements.Add(new Button((uint)(pomX * 0.40), (uint)(pomY * 0.70), (uint)(pomX * 0.25), (uint)(pomY * 0.10), "Zamknij", window, buttonscolor, buttontextsize, 0));
            ...
            hudelements.Add(new Button((uint)(pomX * 0.40), (uint)(pomY * 0.42), (uint)(pomX * 0.03), (uint)(pomY * 0.06), "-", window, buttonscolor, buttontextsize, 0));
            hudelements.Add(new Button((uint)(pomX * 0.44), (uint)(pomY * 0.40), (uint)(pomX * 0.17), (uint)(pomY * 0.10), "Głośność", window, buttonscolor, buttontextsize, 0));
            hudelements.Add(new Button((uint)(pomX * 0.62), (uint)(pomY * 0.42), (uint)(pomX * 0.03), (uint)(pomY * 0.06), "+", window, buttonscolor, buttontextsize, 0));
            hudelements.Add(new Button((uint)(pomX * 0.40), (uint)(pomY * 0.70), (uint)(pomX * 0.25), (uint)(pomY * 0.10), "Zamknij", window, buttonscolor, buttontextsize, 0));
            ...
            hudelements.Add(new Button((uint)(pomX * 0.60), (uint)(pomY * 0.715), (uint)(pomX * 0.04), (uint)(pomY * 0.07), "R", window, buttonscolor, buttontextsize, 0));
